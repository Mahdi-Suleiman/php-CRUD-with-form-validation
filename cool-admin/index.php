                    ...
                    <tr>
                        ...
                        <td>
                            <form action="./edit.php" method="GET">
                                <input type="submit" value="Edit" name="edit-user" class="btn btn-success">
                                <input type="hidden" name="hidden-user-id-from-admin"
                                    value=" <?php echo $user['id']; ?>" />
                            </form>
                        </td>
                        <!-- <td>
                            <a href="./edit.php?id=<?php echo $user['id'] ?>"> move</a>
                        </td> -->
                        <td>
                            <form action="./delete.php" method="GET">
                                <input type="submit" value="Delete" name="delete-user" class="btn btn-danger"
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix">
                                                ...
                                                <span
                                                    class="direct-chat-name float-left"><?php echo "" . $_SESSION['loggedUser']['username']; ?></span>
                                        ...
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix">
                                                <!-- <span class="direct-chat-name float-left">Alexander Pierce</span> -->
                                                <span
                                                    class="direct-chat-name float-left"><?php echo "" . $_SESSION['loggedUser']['username']; ?>Pierce</span>
